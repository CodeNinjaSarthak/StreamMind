...
class Answer(Base):
    ...
    comment_id = Column(UUID(as_uuid=True), ForeignKey("comments.id", ondelete="SET NULL"), nullable=True, index=True)
    ...
    __table_args__ = (Index("idx_answer_cluster_posted", "cluster_id", "is_posted"),)
